    ...
    sections: {
      ...
      numbers: {
        ...
        sales: {
          ...
          items: [
            { label: '22 транзакції', desc: 'успішно завершені — перші авансові платежі пілоту підтверджені, вийшло на 2 більше, ніж планували - частину вчителів запросили колег' },
