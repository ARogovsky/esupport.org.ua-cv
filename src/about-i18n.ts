...
export const aboutContent = {
  uk: {
    ...
    altSlug: 'about-en',
    seo: {
      title: 'Андрій Роговський | Forward Deployed AI Engineer · GenAI · MLOps',
      description: 'Forward Deployed Engineer з 25 роками досвіду в хмарній інфраструктурі та безпеці. Вбудовуюсь у команду клієнта і доводжу GenAI до production: agentic workflows, RAG pipelines, MLOps.',
    },
    heading: 'Андрій Роговський',
    manifesto: '25 років інфраструктури. Тепер я будую AI, який виживає в продакшні.',
    subtitle: 'Forward Deployed AI Engineer · GenAI · MLOps · Cloud',
    location: 'Німеччина',
    lastUpdated: 'Квітень 2026',
    bio: [
      'Forward Deployed AI Engineer з 25 роками досвіду в хмарній інфраструктурі та безпеці. Вбудовуюсь у команду клієнта і доводжу GenAI до production — будую агентні воркфлоу та RAG-пайплайни на LangGraph, LangChain та Agno, розгорнуті в 5+ комерційних продуктах.',
    ...
    sections: {
      ...
      projects: [
        ...
        { name: 'E-lli.com', desc: 'Self-reflection assistant: трансформація сесій з психологами у Vector DB + RAG', href: 'https://e-lli.com' },
      ],
      ...
      faq: [
        { q: 'Хто такий Андрій Роговський?', a: 'Forward Deployed AI Engineer з 25 роками досвіду в хмарній інфраструктурі та безпеці. Вбудовується у команду клієнта і доводить GenAI до production — будує агентні воркфлоу та RAG-пайплайни на LangGraph, LangChain та Agno, розгорнуті в 5+ комерційних продуктах. Засновник Bablo Digital Agency та co-founder E-lli.com.' },
  ...
  en: {
    ...
    altSlug: 'about',
    seo: {
      title: 'Andrey Rogovsky | Forward Deployed AI Engineer · GenAI · MLOps',
      description: 'Forward Deployed Engineer with 25 years of experience. I embed with customer teams and ship GenAI to production: agentic workflows, RAG pipelines, MLOps.',
    },
    ...
    bio: [
      'Forward Deployed AI Engineer with 25 years in cloud infrastructure and security. I embed with customer teams and ship GenAI to production — building agentic workflows and RAG pipelines using LangGraph, LangChain, and Agno, deployed across 5+ commercial products.',
    ...
    sections: {
      ...
      projects: [
        ...
        { name: 'E-lli.com', desc: 'Self-reflection assistant: psychology sessions → Vector DB + RAG', href: 'https://e-lli.com' },
      ],
      ...
      faq: [
        { q: 'Who is Andrey Rogovsky?', a: 'Forward Deployed AI Engineer with 25 years in cloud infrastructure and security. He embeds with customer teams and ships GenAI to production — building agentic workflows and RAG pipelines using LangGraph, LangChain, and Agno, deployed across 5+ commercial products. Founder of Bablo Digital Agency and co-founder of E-lli.com.' },
