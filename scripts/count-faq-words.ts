#!/usr/bin/env tsx
/**
 * Count words in FAQ answers to verify they meet the 100-word minimum
 */

import { perfectSquadContent } from '../src/perfectsquad-i18n'
...
function analyzeFAQ(lang: 'uk' | 'en') {
  ...
  const faq = perfectSquadContent[lang].faq.items
  let totalWords = 0
...
console.log('📊 PerfectSquad FAQ Word Count Analysis')
analyzeFAQ('uk')
analyzeFAQ('en')
